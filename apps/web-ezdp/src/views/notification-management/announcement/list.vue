...
const [Grid, gridApi] = useVbenVxeGrid({
  ...
  } as VxeTableGridOptions<AnnouncementApi.AnnouncementItem>,
});
...
function onActionClick(
  e: OnActionClickParams<AnnouncementApi.AnnouncementItem>,
) {
  switch (e.code) {
    case 'delete': {
      onDelete(e.row);
...
function onDelete(row: AnnouncementApi.AnnouncementItem) {
  confirm(
    $t('ui.confirmContent.delete', [row.title]),
...
<template>
  <Page auto-content-height>
    ...
    <Grid :table-title="$t('notification.announcement.title')">
